...
WHERE movie_id IN (SELECT movie_actor.movie_id FROM movie_actor JOIN person ON movie_actor.actor_id = person.person_id WHERE person.person_name = 'Bill Murray')