...
SELECT census_region, COUNT(census_region) AS num_states FROM state WHERE census_region IS NOT NULL GROUP BY census_region ORDER BY COUNT(census_region) DESC